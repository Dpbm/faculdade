...
INSERT INTO dependente(CodEmp, CodDep, Nome, RG, Sexo, Data_Nasc, Grau_Parentesco) VALUES (2,3,'Marcelo','256398563','M','1981-03-14','Filho');
INSERT INTO dependente(CodEmp, CodDep, Nome, RG, Sexo, Data_Nasc, Grau_Parentesco) VALUES (4,4,'Mariana','569856423','F','1983-11-15', 'Filha');
INSERT INTO dependente(CodEmp, CodDep, Nome, RG, Sexo, Data_Nasc, Grau_Parentesco) VALUES (4,5,'Fernanda','856985412','F','1965-03-18', 'Esposa');
INSERT INTO dependente(CodEmp, CodDep, Nome, RG, Sexo, Data_Nasc, Grau_Parentesco) VALUES (6,6,'Rafaela',NULL,'F','2000-12-16', 'Filha');
INSERT INTO dependente(CodEmp, CodDep, Nome, RG, Sexo, Data_Nasc, Grau_Parentesco) VALUES (8,7,'Jessica',NULL,'F','1992-03-22', 'Filha');
INSERT INTO dependente(CodEmp, CodDep, Nome, RG, Sexo, Data_Nasc, Grau_Parentesco) VALUES (8,8,'Lucas',NULL,'M','1992-03-22', 'Filho');
...
SELECT projeto.Nome
    ...
    WHERE (
		...
		SELECT SUM(Horas)/count(DISTINCT CodProj)
        FROM projeto_empregado
    );
